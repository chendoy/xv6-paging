...
00000020 <simple_printf_test>:
{
  ...
  23:	83 ec 10             	sub    $0x10,%esp
    printf(1, "\n-------- simple_printf_test --------\n");
  26:	68 48 08 00 00       	push   $0x848
  2b:	6a 01                	push   $0x1
  2d:	e8 be 04 00 00       	call   4f0 <printf>
   printf(1, "sanity test!\n");
  32:	58                   	pop    %eax
  33:	5a                   	pop    %edx
  34:	68 3c 09 00 00       	push   $0x93c
  39:	6a 01                	push   $0x1
...
00000080 <simple_fork_test>:
{
  ...
  83:	83 ec 10             	sub    $0x10,%esp
    printf(1, "\n-------- simple_fork_test --------\n");
  86:	68 c4 08 00 00       	push   $0x8c4
  8b:	6a 01                	push   $0x1
  8d:	e8 5e 04 00 00       	call   4f0 <printf>
    if((pid = fork()) == 0) // child
  92:	e8 f3 02 00 00       	call   38a <fork>
  ...
  a1:	6a 14                	push   $0x14
  a3:	e8 7a 03 00 00       	call   422 <sleep>
        printf(1, "I'm parent!\n");
  a8:	58                   	pop    %eax
  a9:	5a                   	pop    %edx
  aa:	68 56 09 00 00       	push   $0x956
  af:	6a 01                	push   $0x1
  ...
  b9:	c9                   	leave  
        wait();
  ba:	e9 db 02 00 00       	jmp    39a <wait>
        printf(1, "I'm child!\n");
  bf:	51                   	push   %ecx
  c0:	51                   	push   %ecx
  c1:	68 4a 09 00 00       	push   $0x94a
  c6:	6a 01                	push   $0x1
  c8:	e8 23 04 00 00       	call   4f0 <printf>
        exit();
  cd:	e8 c0 02 00 00       	call   392 <exit>
...
000000e0 <pagefault_test>:
{
  ...
  e3:	83 ec 10             	sub    $0x10,%esp
    printf(1, "\n-------- pagefault_test --------\n");
  e6:	68 ec 08 00 00       	push   $0x8ec
  eb:	6a 01                	push   $0x1
  ed:	e8 fe 03 00 00       	call   4f0 <printf>
    memset(buf, 'a', BUF_PAGES * 4096);
  f2:	83 c4 0c             	add    $0xc,%esp
  f5:	68 00 10 01 00       	push   $0x11000
  fa:	6a 61                	push   $0x61
  fc:	68 c0 0c 00 00       	push   $0xcc0
 101:	e8 ea 00 00 00       	call   1f0 <memset>
    printf(1, "buf[0] = %c, buf[mid] = %c, buf[end] = %c\n", buf[0], buf[ (BUF_PAGES/2) * 4096 - 1], buf[BUF_PAGES * 4096 - 1]);
 106:	0f be 05 bf 1c 01 00 	movsbl 0x11cbf,%eax
 10d:	89 04 24             	mov    %eax,(%esp)
 110:	0f be 05 bf 8c 00 00 	movsbl 0x8cbf,%eax
 117:	50                   	push   %eax
 118:	0f be 05 c0 0c 00 00 	movsbl 0xcc0,%eax
 11f:	50                   	push   %eax
 120:	68 10 09 00 00       	push   $0x910
 125:	6a 01                	push   $0x1
 127:	e8 c4 03 00 00       	call   4f0 <printf>
    return;
 ...
 459:	85 d2                	test   %edx,%edx
{
 ...
 487:	f7 f1                	div    %ecx
 489:	0f b6 92 6c 09 00 00 	movzbl 0x96c(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 6a4:	e9 8f fe ff ff       	jmp    538 <printf+0x48>
          s = "(null)";
 6a9:	bb 63 09 00 00       	mov    $0x963,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6c1:	a1 a0 0c 00 00       	mov    0xca0,%eax
{
 ...
 6fd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6ff:	a3 a0 0c 00 00       	mov    %eax,0xca0
}
 704:	5b                   	pop    %ebx
 705:	5e                   	pop    %esi
 706:	5f                   	pop    %edi
 ...
 716:	72 ce                	jb     6e6 <free+0x26>
{
 ...
 737:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 73a:	a3 a0 0c 00 00       	mov    %eax,0xca0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 759:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 75c:	8b 15 a0 0c 00 00    	mov    0xca0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 79f:	73 47                	jae    7e8 <malloc+0x98>
    ...
    if(p == freep)
 7a1:	39 05 a0 0c 00 00    	cmp    %eax,0xca0
 ...
 7c6:	e8 f5 fe ff ff       	call   6c0 <free>
  return freep;
 7cb:	8b 15 a0 0c 00 00    	mov    0xca0,%edx
 ...
 7f4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7f7:	89 15 a0 0c 00 00    	mov    %edx,0xca0
}
 ...
 809:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 810:	c7 05 a0 0c 00 00 a4 	movl   $0xca4,0xca0
 817:	0c 00 00 
 81a:	c7 05 a4 0c 00 00 a4 	movl   $0xca4,0xca4
 821:	0c 00 00 
    base.s.size = 0;
 824:	b8 a4 0c 00 00       	mov    $0xca4,%eax
 829:	c7 05 a8 0c 00 00 00 	movl   $0x0,0xca8
 830:	00 00 00 
