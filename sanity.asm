...
00000020 <simple_printf_test>:
{
  ...
  2b:	6a 01                	push   $0x1
  2d:	e8 8e 04 00 00       	call   4c0 <printf>
   printf(1, "sanity test!\n");
  32:	58                   	pop    %eax
  33:	5a                   	pop    %edx
  34:	68 bc 08 00 00       	push   $0x8bc
  39:	6a 01                	push   $0x1
...
00000080 <simple_fork_test>:
{
  ...
  8d:	e8 2e 04 00 00       	call   4c0 <printf>
    if((pid = fork()) == 0) // child
  92:	e8 c3 02 00 00       	call   35a <fork>
  ...
  a1:	6a 14                	push   $0x14
  a3:	e8 4a 03 00 00       	call   3f2 <sleep>
        printf(1, "I'm parent!\n");
  a8:	58                   	pop    %eax
  a9:	5a                   	pop    %edx
  aa:	68 d6 08 00 00       	push   $0x8d6
  af:	6a 01                	push   $0x1
  ...
  b9:	c9                   	leave  
        wait();
  ba:	e9 ab 02 00 00       	jmp    36a <wait>
        printf(1, "I'm child!\n");
  bf:	51                   	push   %ecx
  c0:	51                   	push   %ecx
  ...
  c8:	e8 f3 03 00 00       	call   4c0 <printf>
        exit();
  cd:	e8 90 02 00 00       	call   362 <exit>
 ...
 429:	85 d2                	test   %edx,%edx
{
 ...
 457:	f7 f1                	div    %ecx
 459:	0f b6 92 ec 08 00 00 	movzbl 0x8ec(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 674:	e9 8f fe ff ff       	jmp    508 <printf+0x48>
          s = "(null)";
 679:	bb e3 08 00 00       	mov    $0x8e3,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 691:	a1 14 0c 00 00       	mov    0xc14,%eax
{
 ...
 6cd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6cf:	a3 14 0c 00 00       	mov    %eax,0xc14
}
 6d4:	5b                   	pop    %ebx
 6d5:	5e                   	pop    %esi
 6d6:	5f                   	pop    %edi
 ...
 6e6:	72 ce                	jb     6b6 <free+0x26>
{
 ...
 707:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 70a:	a3 14 0c 00 00       	mov    %eax,0xc14
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 15 14 0c 00 00    	mov    0xc14,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 76f:	73 47                	jae    7b8 <malloc+0x98>
    ...
    if(p == freep)
 771:	39 05 14 0c 00 00    	cmp    %eax,0xc14
 ...
 796:	e8 f5 fe ff ff       	call   690 <free>
  return freep;
 79b:	8b 15 14 0c 00 00    	mov    0xc14,%edx
 ...
 7c4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7c7:	89 15 14 0c 00 00    	mov    %edx,0xc14
}
 ...
 7e7:	0c 00 00 
 7ea:	c7 05 18 0c 00 00 18 	movl   $0xc18,0xc18
 7f1:	0c 00 00 
    base.s.size = 0;
 7f4:	b8 18 0c 00 00       	mov    $0xc18,%eax
