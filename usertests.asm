...
00000d80 <mem>:
{
  ...
  ppid = getpid();
     d97:	e8 a6 2b 00 00       	call   3942 <getpid>
     d9c:	89 c6                	mov    %eax,%esi
  if((pid = fork()) == 0){
     d9e:	e8 17 2b 00 00       	call   38ba <fork>
    ...
    exit();
     ...
     e2a:	e8 c3 2a 00 00       	call   38f2 <kill>
      exit();
     ...
     e3e:	5d                   	pop    %ebp
    wait();
     e3f:	e9 86 2a 00 00       	jmp    38ca <wait>
...
00000e50 <sharedfd>:
{
  ...
  pid = fork();
     e94:	e8 21 2a 00 00       	call   38ba <fork>
  memset(buf, pid==0?'c':'p', sizeof(buf));
  ...
  memset(buf, pid==0?'c':'p', sizeof(buf));
     ...
     eaf:	50                   	push   %eax
     eb0:	e8 6b 28 00 00       	call   3720 <memset>
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     ecd:	50                   	push   %eax
     ece:	56                   	push   %esi
     ecf:	e8 0e 2a 00 00       	call   38e2 <write>
  ...
  close(fd);
     ...
     f06:	e8 df 29 00 00       	call   38ea <close>
  fd = open("sharedfd", 0);
     f0b:	58                   	pop    %eax
     f0c:	5a                   	pop    %edx
     f0d:	6a 00                	push   $0x0
     f0f:	68 b3 41 00 00       	push   $0x41b3
     f14:	e8 e9 29 00 00       	call   3902 <open>
  if(fd < 0){
  ...
  close(fd);
     ...
     f7c:	e8 69 29 00 00       	call   38ea <close>
  unlink("sharedfd");
     f81:	c7 04 24 b3 41 00 00 	movl   $0x41b3,(%esp)
     f88:	e8 85 29 00 00       	call   3912 <unlink>
  if(nc == 10000 && np == 10000){
    ...
    return;
     ...
     ff3:	c3                   	ret    
    exit();
     ff4:	e8 c9 28 00 00       	call   38c2 <exit>
    ...
    exit();
    1007:	e8 b6 28 00 00       	call   38c2 <exit>
    ...
    101b:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fourfiles test\n");
    ...
    105e:	0f 88 88 01 00 00    	js     11ec <fourfiles+0x1dc>
    if(pid == 0){
    1064:	0f 84 ff 00 00 00    	je     1169 <fourfiles+0x159>
  for(pi = 0; pi < 4; pi++){
  ...
  for(i = 0; i < 2; i++){
    ...
    wait();
    107f:	e8 46 28 00 00       	call   38ca <wait>
    1084:	e8 41 28 00 00       	call   38ca <wait>
    1089:	e8 3c 28 00 00       	call   38ca <wait>
    108e:	c7 45 cc de 41 00 00 	movl   $0x41de,-0x34(%ebp)
    fd = open(fname, 0);
    ...
    fd = open(fname, 0);
    109a:	6a 00                	push   $0x0
    109c:	ff 75 cc             	pushl  -0x34(%ebp)
    109f:	e8 5e 28 00 00       	call   3902 <open>
    while((n = read(fd, buf, sizeof(buf))) > 0){
    10a4:	83 c4 10             	add    $0x10,%esp
    fd = open(fname, 0);
    10a7:	89 45 d0             	mov    %eax,-0x30(%ebp)
    10aa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    while((n = read(fd, buf, sizeof(buf))) > 0){
    10b0:	83 ec 04             	sub    $0x4,%esp
    10b3:	68 00 20 00 00       	push   $0x2000
    10b8:	68 20 86 00 00       	push   $0x8620
    10bd:	ff 75 d0             	pushl  -0x30(%ebp)
    10c0:	e8 15 28 00 00       	call   38da <read>
    10c5:	83 c4 10             	add    $0x10,%esp
    10c8:	85 c0                	test   %eax,%eax
    10ca:	7e 46                	jle    1112 <fourfiles+0x102>
      printf(1, "bytes read: %d\n", n);
    10cc:	83 ec 04             	sub    $0x4,%esp
    10cf:	89 45 d4             	mov    %eax,-0x2c(%ebp)
    10d2:	50                   	push   %eax
    10d3:	68 05 42 00 00       	push   $0x4205
    10d8:	6a 01                	push   $0x1
    10da:	e8 41 29 00 00       	call   3a20 <printf>
      for(j = 0; j < n; j++){
    10df:	8b 45 d4             	mov    -0x2c(%ebp),%eax
      printf(1, "bytes read: %d\n", n);
  ...
  printf(1, "fourfiles ok\n");
    ...
    1161:	89 45 cc             	mov    %eax,-0x34(%ebp)
    1164:	e9 2c ff ff ff       	jmp    1095 <fourfiles+0x85>
    ...
    117c:	89 c6                	mov    %eax,%esi
      if(fd < 0){
    117e:	78 59                	js     11d9 <fourfiles+0x1c9>
      memset(buf, '0'+pi, 512);
    ...
    11b9:	75 57                	jne    1212 <fourfiles+0x202>
      for(i = 0; i < 12; i++){
    11bb:	83 eb 01             	sub    $0x1,%ebx
    11be:	75 de                	jne    119e <fourfiles+0x18e>
      exit();
    11c0:	e8 fd 26 00 00       	call   38c2 <exit>
          printf(1, "wrong char\n");
    11c5:	83 ec 08             	sub    $0x8,%esp
    11c8:	68 15 42 00 00       	push   $0x4215
    11cd:	6a 01                	push   $0x1
    ...
    11d9:	51                   	push   %ecx
    11da:	51                   	push   %ecx
    11db:	68 8f 44 00 00       	push   $0x448f
    11e0:	6a 01                	push   $0x1
    ...
    11ec:	53                   	push   %ebx
    11ed:	53                   	push   %ebx
    11ee:	68 c9 4c 00 00       	push   $0x4cc9
    11f3:	6a 01                	push   $0x1
    ...
    11ff:	50                   	push   %eax
    1200:	53                   	push   %ebx
    1201:	68 21 42 00 00       	push   $0x4221
    1206:	6a 01                	push   $0x1
    ...
    1236:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete test\n");
    123b:	68 40 42 00 00       	push   $0x4240
    1240:	6a 01                	push   $0x1
  ...
  printf(1, "createdelete ok\n");
    ...
    1334:	68 53 42 00 00       	push   $0x4253
    1339:	6a 01                	push   $0x1
    ...
    13f0:	57                   	push   %edi
    13f1:	68 00 4f 00 00       	push   $0x4f00
    13f6:	6a 01                	push   $0x1
    ...
    1402:	51                   	push   %ecx
    1403:	51                   	push   %ecx
    1404:	68 8f 44 00 00       	push   $0x448f
    1409:	6a 01                	push   $0x1
    ...
    1415:	53                   	push   %ebx
    1416:	53                   	push   %ebx
    1417:	68 c9 4c 00 00       	push   $0x4cc9
    141c:	6a 01                	push   $0x1
    ...
    1430:	50                   	push   %eax
    1431:	57                   	push   %edi
    1432:	68 24 4f 00 00       	push   $0x4f24
    1437:	6a 01                	push   $0x1
...
00001450 <unlinkread>:
{
  ...
  printf(1, "unlinkread test\n");
    ...
    1458:	68 64 42 00 00       	push   $0x4264
    145d:	6a 01                	push   $0x1
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    146b:	68 75 42 00 00       	push   $0x4275
  ...
  write(fd, "hello", 5);
    ...
    1485:	6a 05                	push   $0x5
    1487:	68 9a 42 00 00       	push   $0x429a
    148c:	50                   	push   %eax
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    149b:	5a                   	pop    %edx
    149c:	6a 02                	push   $0x2
    149e:	68 75 42 00 00       	push   $0x4275
  ...
  if(unlink("unlinkread") != 0){
    ...
    14b8:	68 75 42 00 00       	push   $0x4275
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    14d5:	68 75 42 00 00       	push   $0x4275
  ...
  write(fd1, "yyy", 3);
    14e4:	6a 03                	push   $0x3
    14e6:	68 d2 42 00 00       	push   $0x42d2
    14eb:	50                   	push   %eax
  ...
  unlink("unlinkread");
    1542:	c7 04 24 75 42 00 00 	movl   $0x4275,(%esp)
    1549:	e8 c4 23 00 00       	call   3912 <unlink>
  printf(1, "unlinkread ok\n");
    154e:	58                   	pop    %eax
    154f:	5a                   	pop    %edx
    1550:	68 1d 43 00 00       	push   $0x431d
    1555:	6a 01                	push   $0x1
    ...
    1566:	51                   	push   %ecx
    1567:	51                   	push   %ecx
    1568:	68 80 42 00 00       	push   $0x4280
    156d:	6a 01                	push   $0x1
    ...
    1579:	51                   	push   %ecx
    157a:	51                   	push   %ecx
    157b:	68 04 43 00 00       	push   $0x4304
    1580:	6a 01                	push   $0x1
    ...
    158c:	53                   	push   %ebx
    158d:	53                   	push   %ebx
    158e:	68 ed 42 00 00       	push   $0x42ed
    1593:	6a 01                	push   $0x1
    ...
    159f:	56                   	push   %esi
    15a0:	56                   	push   %esi
    15a1:	68 d6 42 00 00       	push   $0x42d6
    15a6:	6a 01                	push   $0x1
    ...
    15b2:	50                   	push   %eax
    15b3:	50                   	push   %eax
    15b4:	68 b8 42 00 00       	push   $0x42b8
    15b9:	6a 01                	push   $0x1
    ...
    15c5:	50                   	push   %eax
    15c6:	50                   	push   %eax
    15c7:	68 a0 42 00 00       	push   $0x42a0
    15cc:	6a 01                	push   $0x1
...
000015e0 <linktest>:
{
  ...
  printf(1, "linktest\n");
    15e7:	68 2c 43 00 00       	push   $0x432c
    15ec:	6a 01                	push   $0x1
    15ee:	e8 2d 24 00 00       	call   3a20 <printf>
  unlink("lf1");
    15f3:	c7 04 24 36 43 00 00 	movl   $0x4336,(%esp)
    15fa:	e8 13 23 00 00       	call   3912 <unlink>
  unlink("lf2");
    15ff:	c7 04 24 3a 43 00 00 	movl   $0x433a,(%esp)
    1606:	e8 07 23 00 00       	call   3912 <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
    160b:	58                   	pop    %eax
    160c:	5a                   	pop    %edx
    160d:	68 02 02 00 00       	push   $0x202
    1612:	68 36 43 00 00       	push   $0x4336
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    162c:	6a 05                	push   $0x5
    162e:	68 9a 42 00 00       	push   $0x429a
    1633:	50                   	push   %eax
  ...
  if(link("lf1", "lf2") < 0){
    164e:	5b                   	pop    %ebx
    164f:	58                   	pop    %eax
    1650:	68 3a 43 00 00       	push   $0x433a
    1655:	68 36 43 00 00       	push   $0x4336
  ...
  unlink("lf1");
    ...
    166d:	68 36 43 00 00       	push   $0x4336
    1672:	e8 9b 22 00 00       	call   3912 <unlink>
  if(open("lf1", 0) >= 0){
    1677:	58                   	pop    %eax
    1678:	5a                   	pop    %edx
    1679:	6a 00                	push   $0x0
    167b:	68 36 43 00 00       	push   $0x4336
  ...
  fd = open("lf2", 0);
    ...
    1693:	6a 00                	push   $0x0
    1695:	68 3a 43 00 00       	push   $0x433a
  ...
  if(link("lf2", "lf2") >= 0){
    16d4:	58                   	pop    %eax
    16d5:	5a                   	pop    %edx
    16d6:	68 3a 43 00 00       	push   $0x433a
    16db:	68 3a 43 00 00       	push   $0x433a
  ...
  unlink("lf2");
    ...
    16f3:	68 3a 43 00 00       	push   $0x433a
    16f8:	e8 15 22 00 00       	call   3912 <unlink>
  if(link("lf2", "lf1") >= 0){
    16fd:	59                   	pop    %ecx
    16fe:	5b                   	pop    %ebx
    16ff:	68 36 43 00 00       	push   $0x4336
    1704:	68 3a 43 00 00       	push   $0x433a
  ...
  if(link(".", "lf1") >= 0){
    ...
    1718:	68 36 43 00 00       	push   $0x4336
    171d:	68 fe 45 00 00       	push   $0x45fe
  ...
  printf(1, "linktest ok\n");
    ...
    1731:	68 d4 43 00 00       	push   $0x43d4
    1736:	6a 01                	push   $0x1
    ...
    1745:	50                   	push   %eax
    1746:	50                   	push   %eax
    1747:	68 3e 43 00 00       	push   $0x433e
    174c:	6a 01                	push   $0x1
    ...
    1758:	50                   	push   %eax
    1759:	50                   	push   %eax
    175a:	68 b8 43 00 00       	push   $0x43b8
    175f:	6a 01                	push   $0x1
    ...
    176b:	52                   	push   %edx
    176c:	52                   	push   %edx
    176d:	68 6c 4f 00 00       	push   $0x4f6c
    1772:	6a 01                	push   $0x1
    ...
    177e:	50                   	push   %eax
    177f:	50                   	push   %eax
    1780:	68 9a 43 00 00       	push   $0x439a
    1785:	6a 01                	push   $0x1
    ...
    1791:	51                   	push   %ecx
    1792:	51                   	push   %ecx
    1793:	68 89 43 00 00       	push   $0x4389
    1798:	6a 01                	push   $0x1
    ...
    17a4:	53                   	push   %ebx
    17a5:	53                   	push   %ebx
    17a6:	68 78 43 00 00       	push   $0x4378
    17ab:	6a 01                	push   $0x1
    ...
    17b7:	50                   	push   %eax
    17b8:	50                   	push   %eax
    17b9:	68 44 4f 00 00       	push   $0x4f44
    17be:	6a 01                	push   $0x1
    ...
    17ca:	51                   	push   %ecx
    17cb:	51                   	push   %ecx
    17cc:	68 63 43 00 00       	push   $0x4363
    17d1:	6a 01                	push   $0x1
    ...
    17dd:	50                   	push   %eax
    17de:	50                   	push   %eax
    17df:	68 51 43 00 00       	push   $0x4351
    17e4:	6a 01                	push   $0x1
    ...
    17fb:	bf ab aa aa aa       	mov    $0xaaaaaaab,%edi
{
  ...
  printf(1, "concreate test\n");
    1803:	68 e1 43 00 00       	push   $0x43e1
    1808:	6a 01                	push   $0x1
  ...
  for(i = 0; i < 40; i++){
    ...
    18b5:	53                   	push   %ebx
    18b6:	68 f4 43 00 00       	push   $0x43f4
    18bb:	6a 01                	push   $0x1
    ...
    18d3:	53                   	push   %ebx
    18d4:	68 f1 43 00 00       	push   $0x43f1
  ...
  for(i = 0; i < 40; i++){
    18f3:	83 c6 01             	add    $0x1,%esi
      link("C0", file);
    18f6:	53                   	push   %ebx
    18f7:	68 f1 43 00 00       	push   $0x43f1
  ...
  fd = open(".", 0);
    ...
    1923:	58                   	pop    %eax
    1924:	6a 00                	push   $0x0
    1926:	68 fe 45 00 00       	push   $0x45fe
  ...
  printf(1, "concreate ok\n");
    ...
    1a73:	68 46 44 00 00       	push   $0x4446
    1a78:	6a 01                	push   $0x1
    ...
    1a8a:	68 c9 4c 00 00       	push   $0x4cc9
    1a8f:	6a 01                	push   $0x1
    ...
    1a9b:	51                   	push   %ecx
    1a9c:	51                   	push   %ecx
    1a9d:	68 90 4f 00 00       	push   $0x4f90
    1aa2:	6a 01                	push   $0x1
    ...
    1ab1:	53                   	push   %ebx
    1ab2:	50                   	push   %eax
    1ab3:	68 29 44 00 00       	push   $0x4429
    1ab8:	6a 01                	push   $0x1
    ...
    1ac7:	56                   	push   %esi
    1ac8:	50                   	push   %eax
    1ac9:	68 10 44 00 00       	push   $0x4410
    1ace:	6a 01                	push   $0x1
...
00001af0 <linkunlink>:
{
  ...
  printf(1, "linkunlink test\n");
    1af9:	68 54 44 00 00       	push   $0x4454
    1afe:	6a 01                	push   $0x1
    1b00:	e8 1b 1f 00 00       	call   3a20 <printf>
  unlink("x");
    1b05:	c7 04 24 e1 46 00 00 	movl   $0x46e1,(%esp)
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1b48:	68 e1 46 00 00       	push   $0x46e1
  ...
  for(i = 0; i < 100; i++){
    ...
    1b7d:	68 e1 46 00 00       	push   $0x46e1
  ...
  printf(1, "linkunlink ok\n");
    ...
    1ba6:	68 69 44 00 00       	push   $0x4469
    1bab:	6a 01                	push   $0x1
    ...
    1bc3:	68 e1 46 00 00       	push   $0x46e1
    1bc8:	68 65 44 00 00       	push   $0x4465
    ...
    1bda:	52                   	push   %edx
    1bdb:	52                   	push   %edx
    1bdc:	68 c9 4c 00 00       	push   $0x4cc9
    1be1:	6a 01                	push   $0x1
...
00001c00 <bigdir>:
{
  ...
  printf(1, "bigdir test\n");
    1c09:	68 78 44 00 00       	push   $0x4478
    1c0e:	6a 01                	push   $0x1
    1c10:	e8 0b 1e 00 00       	call   3a20 <printf>
  unlink("bd");
    1c15:	c7 04 24 85 44 00 00 	movl   $0x4485,(%esp)
    1c1c:	e8 f1 1c 00 00       	call   3912 <unlink>
  fd = open("bd", O_CREATE);
    1c21:	5a                   	pop    %edx
    1c22:	59                   	pop    %ecx
    1c23:	68 00 02 00 00       	push   $0x200
    1c28:	68 85 44 00 00       	push   $0x4485
  ...
  close(fd);
    ...
    if(link("bd", name) != 0){
    1c5c:	57                   	push   %edi
    1c5d:	68 85 44 00 00       	push   $0x4485
    name[1] = '0' + (i / 64);
  ...
  unlink("bd");
    ...
    1c93:	68 85 44 00 00       	push   $0x4485
  ...
  printf(1, "bigdir ok\n");
    ...
    1cdc:	68 c7 44 00 00       	push   $0x44c7
    1ce1:	6a 01                	push   $0x1
    ...
    1cf6:	68 9e 44 00 00       	push   $0x449e
    1cfb:	6a 01                	push   $0x1
    ...
    1d0a:	68 b2 44 00 00       	push   $0x44b2
    1d0f:	6a 01                	push   $0x1
    ...
    1d1b:	50                   	push   %eax
    1d1c:	50                   	push   %eax
    1d1d:	68 88 44 00 00       	push   $0x4488
    1d22:	6a 01                	push   $0x1
...
00001d30 <subdir>:
{
  ...
  printf(1, "subdir test\n");
    1d37:	68 d2 44 00 00       	push   $0x44d2
    1d3c:	6a 01                	push   $0x1
    1d3e:	e8 dd 1c 00 00       	call   3a20 <printf>
  unlink("ff");
    1d43:	c7 04 24 5b 45 00 00 	movl   $0x455b,(%esp)
    1d4a:	e8 c3 1b 00 00       	call   3912 <unlink>
  if(mkdir("dd") != 0){
    1d4f:	c7 04 24 f8 45 00 00 	movl   $0x45f8,(%esp)
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d6e:	68 31 45 00 00       	push   $0x4531
  ...
  write(fd, "ff", 2);
    ...
    1d88:	6a 02                	push   $0x2
    1d8a:	68 5b 45 00 00       	push   $0x455b
    1d8f:	50                   	push   %eax
  ...
  if(unlink("dd") >= 0){
    1d9d:	c7 04 24 f8 45 00 00 	movl   $0x45f8,(%esp)
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1db7:	68 0c 45 00 00       	push   $0x450c
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1dd4:	68 2e 45 00 00       	push   $0x452e
  ...
  write(fd, "FF", 2);
    ...
    1dee:	6a 02                	push   $0x2
    1df0:	68 4f 45 00 00       	push   $0x454f
    1df5:	50                   	push   %eax
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1e04:	5a                   	pop    %edx
    1e05:	6a 00                	push   $0x0
    1e07:	68 52 45 00 00       	push   $0x4552
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1e53:	5b                   	pop    %ebx
    1e54:	58                   	pop    %eax
    1e55:	68 92 45 00 00       	push   $0x4592
    1e5a:	68 2e 45 00 00       	push   $0x452e
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1e72:	68 2e 45 00 00       	push   $0x452e
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1e8a:	6a 00                	push   $0x0
    1e8c:	68 2e 45 00 00       	push   $0x452e
  ...
  if(chdir("dd") != 0){
    ...
    1ea4:	68 f8 45 00 00       	push   $0x45f8
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1ebc:	68 c6 45 00 00       	push   $0x45c6
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1ed4:	68 ec 45 00 00       	push   $0x45ec
  ...
  if(chdir("./..") != 0){
    ...
    1eec:	68 fb 45 00 00       	push   $0x45fb
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1f04:	6a 00                	push   $0x0
    1f06:	68 92 45 00 00       	push   $0x4592
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1f46:	5b                   	pop    %ebx
    1f47:	6a 00                	push   $0x0
    1f49:	68 2e 45 00 00       	push   $0x452e
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f66:	68 46 46 00 00       	push   $0x4646
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f83:	68 6b 46 00 00       	push   $0x466b
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1fa0:	68 f8 45 00 00       	push   $0x45f8
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1fb8:	6a 02                	push   $0x2
    1fba:	68 f8 45 00 00       	push   $0x45f8
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1fd2:	6a 01                	push   $0x1
    1fd4:	68 f8 45 00 00       	push   $0x45f8
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1fec:	68 da 46 00 00       	push   $0x46da
    1ff1:	68 46 46 00 00       	push   $0x4646
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    2009:	68 da 46 00 00       	push   $0x46da
    200e:	68 6b 46 00 00       	push   $0x466b
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2026:	68 92 45 00 00       	push   $0x4592
    202b:	68 31 45 00 00       	push   $0x4531
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2043:	68 46 46 00 00       	push   $0x4646
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    205b:	68 6b 46 00 00       	push   $0x466b
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2073:	68 92 45 00 00       	push   $0x4592
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    208b:	68 6b 46 00 00       	push   $0x466b
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    20a3:	68 46 46 00 00       	push   $0x4646
  ...
  if(chdir("dd/ff") == 0){
    ...
    20bb:	68 31 45 00 00       	push   $0x4531
  ...
  if(chdir("dd/xx") == 0){
    ...
    20d3:	68 dd 46 00 00       	push   $0x46dd
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    20eb:	68 92 45 00 00       	push   $0x4592
  ...
  if(unlink("dd/ff") != 0){
    ...
    2103:	68 31 45 00 00       	push   $0x4531
  ...
  if(unlink("dd") == 0){
    ...
    211b:	68 f8 45 00 00       	push   $0x45f8
  ...
  if(unlink("dd/dd") < 0){
    ...
    2133:	68 0d 45 00 00       	push   $0x450d
  ...
  if(unlink("dd") < 0){
    ...
    214b:	68 f8 45 00 00       	push   $0x45f8
  ...
  printf(1, "subdir ok\n");
    ...
    2163:	68 da 47 00 00       	push   $0x47da
    2168:	6a 01                	push   $0x1
    ...
    2177:	50                   	push   %eax
    2178:	50                   	push   %eax
    2179:	68 77 45 00 00       	push   $0x4577
    217e:	6a 01                	push   $0x1
    ...
    218a:	50                   	push   %eax
    218b:	50                   	push   %eax
    218c:	68 d2 45 00 00       	push   $0x45d2
    2191:	6a 01                	push   $0x1
    ...
    219d:	52                   	push   %edx
    219e:	52                   	push   %edx
    219f:	68 9d 45 00 00       	push   $0x459d
    21a4:	6a 01                	push   $0x1
    ...
    21b0:	50                   	push   %eax
    21b1:	50                   	push   %eax
    21b2:	68 4f 46 00 00       	push   $0x464f
    21b7:	6a 01                	push   $0x1
    ...
    21c3:	52                   	push   %edx
    21c4:	52                   	push   %edx
    21c5:	68 34 50 00 00       	push   $0x5034
    21ca:	6a 01                	push   $0x1
    ...
    21d6:	52                   	push   %edx
    21d7:	52                   	push   %edx
    21d8:	68 e3 46 00 00       	push   $0x46e3
    21dd:	6a 01                	push   $0x1
    ...
    21e9:	51                   	push   %ecx
    21ea:	51                   	push   %ecx
    21eb:	68 a4 50 00 00       	push   $0x50a4
    21f0:	6a 01                	push   $0x1
    ...
    21fc:	50                   	push   %eax
    21fd:	50                   	push   %eax
    21fe:	68 5e 45 00 00       	push   $0x455e
    2203:	6a 01                	push   $0x1
    ...
    220f:	51                   	push   %ecx
    2210:	51                   	push   %ecx
    2211:	68 37 45 00 00       	push   $0x4537
    2216:	6a 01                	push   $0x1
    ...
    2222:	50                   	push   %eax
    2223:	50                   	push   %eax
    2224:	68 00 46 00 00       	push   $0x4600
    2229:	6a 01                	push   $0x1
    ...
    2235:	51                   	push   %ecx
    2236:	51                   	push   %ecx
    2237:	68 ec 4f 00 00       	push   $0x4fec
    223c:	6a 01                	push   $0x1
    ...
    2248:	53                   	push   %ebx
    2249:	53                   	push   %ebx
    224a:	68 80 50 00 00       	push   $0x5080
    224f:	6a 01                	push   $0x1
    ...
    225b:	50                   	push   %eax
    225c:	50                   	push   %eax
    225d:	68 5c 50 00 00       	push   $0x505c
    2262:	6a 01                	push   $0x1
    ...
    226e:	50                   	push   %eax
    226f:	50                   	push   %eax
    2270:	68 bf 46 00 00       	push   $0x46bf
    2275:	6a 01                	push   $0x1
    ...
    2281:	50                   	push   %eax
    2282:	50                   	push   %eax
    2283:	68 a6 46 00 00       	push   $0x46a6
    2288:	6a 01                	push   $0x1
    ...
    2294:	50                   	push   %eax
    2295:	50                   	push   %eax
    2296:	68 90 46 00 00       	push   $0x4690
    229b:	6a 01                	push   $0x1
    ...
    22a7:	50                   	push   %eax
    22a8:	50                   	push   %eax
    22a9:	68 74 46 00 00       	push   $0x4674
    22ae:	6a 01                	push   $0x1
    ...
    22ba:	50                   	push   %eax
    22bb:	50                   	push   %eax
    22bc:	68 b5 45 00 00       	push   $0x45b5
    22c1:	6a 01                	push   $0x1
    ...
    22cd:	50                   	push   %eax
    22ce:	50                   	push   %eax
    22cf:	68 10 50 00 00       	push   $0x5010
    22d4:	6a 01                	push   $0x1
    ...
    22e0:	53                   	push   %ebx
    22e1:	53                   	push   %ebx
    22e2:	68 13 45 00 00       	push   $0x4513
    22e7:	6a 01                	push   $0x1
    ...
    22f3:	50                   	push   %eax
    22f4:	50                   	push   %eax
    22f5:	68 c4 4f 00 00       	push   $0x4fc4
    22fa:	6a 01                	push   $0x1
    ...
    2306:	50                   	push   %eax
    2307:	50                   	push   %eax
    2308:	68 f7 44 00 00       	push   $0x44f7
    230d:	6a 01                	push   $0x1
    ...
    2319:	50                   	push   %eax
    231a:	50                   	push   %eax
    231b:	68 df 44 00 00       	push   $0x44df
    2320:	6a 01                	push   $0x1
    ...
    232c:	50                   	push   %eax
    232d:	50                   	push   %eax
    232e:	68 c8 47 00 00       	push   $0x47c8
    2333:	6a 01                	push   $0x1
    ...
    233f:	52                   	push   %edx
    2340:	52                   	push   %edx
    2341:	68 b3 47 00 00       	push   $0x47b3
    2346:	6a 01                	push   $0x1
    ...
    2352:	51                   	push   %ecx
    2353:	51                   	push   %ecx
    2354:	68 c8 50 00 00       	push   $0x50c8
    2359:	6a 01                	push   $0x1
    ...
    2365:	53                   	push   %ebx
    2366:	53                   	push   %ebx
    2367:	68 9e 47 00 00       	push   $0x479e
    236c:	6a 01                	push   $0x1
    ...
    2378:	50                   	push   %eax
    2379:	50                   	push   %eax
    237a:	68 86 47 00 00       	push   $0x4786
    237f:	6a 01                	push   $0x1
    ...
    238b:	50                   	push   %eax
    238c:	50                   	push   %eax
    238d:	68 6e 47 00 00       	push   $0x476e
    2392:	6a 01                	push   $0x1
    ...
    239e:	50                   	push   %eax
    239f:	50                   	push   %eax
    23a0:	68 52 47 00 00       	push   $0x4752
    23a5:	6a 01                	push   $0x1
    ...
    23b1:	50                   	push   %eax
    23b2:	50                   	push   %eax
    23b3:	68 36 47 00 00       	push   $0x4736
    23b8:	6a 01                	push   $0x1
    ...
    23c4:	50                   	push   %eax
    23c5:	50                   	push   %eax
    23c6:	68 19 47 00 00       	push   $0x4719
    23cb:	6a 01                	push   $0x1
    ...
    23d7:	50                   	push   %eax
    23d8:	50                   	push   %eax
    23d9:	68 fe 46 00 00       	push   $0x46fe
    23de:	6a 01                	push   $0x1
    ...
    23ea:	50                   	push   %eax
    23eb:	50                   	push   %eax
    23ec:	68 2b 46 00 00       	push   $0x462b
    23f1:	6a 01                	push   $0x1
    ...
    23fd:	50                   	push   %eax
    23fe:	50                   	push   %eax
    23ff:	68 13 46 00 00       	push   $0x4613
    2404:	6a 01                	push   $0x1
...
00002410 <bigwrite>:
{
  ...
  printf(1, "bigwrite test\n");
    ...
    241d:	68 e5 47 00 00       	push   $0x47e5
    2422:	6a 01                	push   $0x1
    2424:	e8 f7 15 00 00       	call   3a20 <printf>
  unlink("bigwrite");
    2429:	c7 04 24 f4 47 00 00 	movl   $0x47f4,(%esp)
    ...
    2448:	68 f4 47 00 00       	push   $0x47f4
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    unlink("bigwrite");
    2496:	c7 04 24 f4 47 00 00 	movl   $0x47f4,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    ...
    24b0:	68 27 48 00 00       	push   $0x4827
    24b5:	6a 01                	push   $0x1
    ...
    24c6:	50                   	push   %eax
    24c7:	53                   	push   %ebx
    24c8:	68 15 48 00 00       	push   $0x4815
    24cd:	6a 01                	push   $0x1
    ...
    24dc:	68 fd 47 00 00       	push   $0x47fd
    24e1:	6a 01                	push   $0x1
...
000024f0 <bigfile>:
{
  ...
  fd = open("bigfile", 0);
    ...
    257e:	5f                   	pop    %edi
    257f:	6a 00                	push   $0x0
    2581:	68 50 48 00 00       	push   $0x4850
  ...
  for(i = 0; ; i++){
    ...
    25ab:	0f be 05 20 86 00 00 	movsbl 0x8620,%eax
  ...
  unlink("bigfile");
    ...
    2605:	68 50 48 00 00       	push   $0x4850
    260a:	e8 03 13 00 00       	call   3912 <unlink>
  printf(1, "bigfile test ok\n");
    260f:	58                   	pop    %eax
    2610:	5a                   	pop    %edx
    2611:	68 df 48 00 00       	push   $0x48df
    2616:	6a 01                	push   $0x1
    ...
    262b:	68 ac 48 00 00       	push   $0x48ac
    2630:	6a 01                	push   $0x1
    ...
    263f:	68 98 48 00 00       	push   $0x4898
    2644:	6a 01                	push   $0x1
    ...
    2653:	68 83 48 00 00       	push   $0x4883
    2658:	6a 01                	push   $0x1
    ...
    2667:	68 58 48 00 00       	push   $0x4858
    266c:	6a 01                	push   $0x1
    ...
    2678:	53                   	push   %ebx
    2679:	53                   	push   %ebx
    267a:	68 6e 48 00 00       	push   $0x486e
    267f:	6a 01                	push   $0x1
    ...
    268b:	50                   	push   %eax
    268c:	50                   	push   %eax
    268d:	68 42 48 00 00       	push   $0x4842
    2692:	6a 01                	push   $0x1
    ...
    269e:	51                   	push   %ecx
    269f:	51                   	push   %ecx
    26a0:	68 c5 48 00 00       	push   $0x48c5
    26a5:	6a 01                	push   $0x1
...
000026c0 <fourteen>:
{
  ...
  printf(1, "fourteen test\n");
    26c6:	68 f0 48 00 00       	push   $0x48f0
    26cb:	6a 01                	push   $0x1
    26cd:	e8 4e 13 00 00       	call   3a20 <printf>
  if(mkdir("12345678901234") != 0){
    26d2:	c7 04 24 2b 49 00 00 	movl   $0x492b,(%esp)
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    26ec:	68 e8 50 00 00       	push   $0x50e8
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2709:	68 38 51 00 00       	push   $0x5138
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2728:	5a                   	pop    %edx
    2729:	6a 00                	push   $0x0
    272b:	68 a8 51 00 00       	push   $0x51a8
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    2745:	c7 04 24 1c 49 00 00 	movl   $0x491c,(%esp)
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    275b:	68 44 52 00 00       	push   $0x5244
  ...
  printf(1, "fourteen ok\n");
    ...
    276f:	68 3a 49 00 00       	push   $0x493a
    2774:	6a 01                	push   $0x1
    ...
    2780:	50                   	push   %eax
    2781:	50                   	push   %eax
    2782:	68 ff 48 00 00       	push   $0x48ff
    2787:	6a 01                	push   $0x1
    ...
    2793:	50                   	push   %eax
    2794:	50                   	push   %eax
    2795:	68 64 52 00 00       	push   $0x5264
    279a:	6a 01                	push   $0x1
    ...
    27a6:	52                   	push   %edx
    27a7:	52                   	push   %edx
    27a8:	68 14 52 00 00       	push   $0x5214
    27ad:	6a 01                	push   $0x1
    ...
    27b9:	51                   	push   %ecx
    27ba:	51                   	push   %ecx
    27bb:	68 d8 51 00 00       	push   $0x51d8
    27c0:	6a 01                	push   $0x1
    ...
    27cc:	51                   	push   %ecx
    27cd:	51                   	push   %ecx
    27ce:	68 68 51 00 00       	push   $0x5168
    27d3:	6a 01                	push   $0x1
    ...
    27df:	50                   	push   %eax
    27e0:	50                   	push   %eax
    27e1:	68 08 51 00 00       	push   $0x5108
    27e6:	6a 01                	push   $0x1
...
00002800 <rmdot>:
{
  ...
  printf(1, "rmdot test\n");
    2806:	68 47 49 00 00       	push   $0x4947
    280b:	6a 01                	push   $0x1
    280d:	e8 0e 12 00 00       	call   3a20 <printf>
  if(mkdir("dots") != 0){
    2812:	c7 04 24 53 49 00 00 	movl   $0x4953,(%esp)
  ...
  if(chdir("dots") != 0){
    ...
    282c:	68 53 49 00 00       	push   $0x4953
  ...
  if(unlink(".") == 0){
    ...
    2844:	68 fe 45 00 00       	push   $0x45fe
  ...
  if(unlink("..") == 0){
    ...
    285c:	68 fd 45 00 00       	push   $0x45fd
  ...
  if(unlink("dots/.") == 0){
    ...
    288c:	68 9b 49 00 00       	push   $0x499b
  ...
  if(unlink("dots/..") == 0){
    ...
    28a0:	68 b9 49 00 00       	push   $0x49b9
  ...
  if(unlink("dots") != 0){
    ...
    28b4:	68 53 49 00 00       	push   $0x4953
  ...
  printf(1, "rmdot ok\n");
    ...
    28c8:	68 ee 49 00 00       	push   $0x49ee
    28cd:	6a 01                	push   $0x1
    ...
    28d9:	50                   	push   %eax
    28da:	50                   	push   %eax
    28db:	68 58 49 00 00       	push   $0x4958
    28e0:	6a 01                	push   $0x1
    ...
    28ec:	50                   	push   %eax
    28ed:	50                   	push   %eax
    28ee:	68 d9 49 00 00       	push   $0x49d9
    28f3:	6a 01                	push   $0x1
    ...
    28ff:	52                   	push   %edx
    2900:	52                   	push   %edx
    2901:	68 c1 49 00 00       	push   $0x49c1
    2906:	6a 01                	push   $0x1
    ...
    2912:	51                   	push   %ecx
    2913:	51                   	push   %ecx
    2914:	68 a2 49 00 00       	push   $0x49a2
    2919:	6a 01                	push   $0x1
    ...
    2938:	50                   	push   %eax
    2939:	50                   	push   %eax
    293a:	68 8c 49 00 00       	push   $0x498c
    293f:	6a 01                	push   $0x1
    ...
    294b:	50                   	push   %eax
    294c:	50                   	push   %eax
    294d:	68 7e 49 00 00       	push   $0x497e
    2952:	6a 01                	push   $0x1
    ...
    295e:	50                   	push   %eax
    295f:	50                   	push   %eax
    2960:	68 6b 49 00 00       	push   $0x496b
    2965:	6a 01                	push   $0x1
...
00002980 <dirfile>:
{
  ...
  printf(1, "dir vs file\n");
    2987:	68 f8 49 00 00       	push   $0x49f8
    298c:	6a 01                	push   $0x1
  ...
  fd = open("dirfile", O_CREATE);
    ...
    299a:	68 05 4a 00 00       	push   $0x4a05
  ...
  if(chdir("dirfile") == 0){
    29b8:	c7 04 24 05 4a 00 00 	movl   $0x4a05,(%esp)
  ...
  fd = open("dirfile/xx", 0);
    ...
    29d2:	6a 00                	push   $0x0
    29d4:	68 3e 4a 00 00       	push   $0x4a3e
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    29f1:	68 3e 4a 00 00       	push   $0x4a3e
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    2a09:	68 3e 4a 00 00       	push   $0x4a3e
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2a21:	68 3e 4a 00 00       	push   $0x4a3e
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2a39:	68 3e 4a 00 00       	push   $0x4a3e
    2a3e:	68 a2 4a 00 00       	push   $0x4aa2
  ...
  if(unlink("dirfile") != 0){
    ...
    2a56:	68 05 4a 00 00       	push   $0x4a05
  ...
  fd = open(".", O_RDWR);
    ...
    2a6e:	6a 02                	push   $0x2
    2a70:	68 fe 45 00 00       	push   $0x45fe
  ...
  fd = open(".", 0);
    ...
    2a88:	6a 00                	push   $0x0
    2a8a:	68 fe 45 00 00       	push   $0x45fe
  ...
  if(write(fd, "x", 1) > 0){
    2a99:	6a 01                	push   $0x1
    2a9b:	68 e1 46 00 00       	push   $0x46e1
    2aa0:	50                   	push   %eax
  ...
  printf(1, "dir vs file OK\n");
    2ab6:	58                   	pop    %eax
    2ab7:	5a                   	pop    %edx
    2ab8:	68 d5 4a 00 00       	push   $0x4ad5
    2abd:	6a 01                	push   $0x1
    ...
    2acc:	50                   	push   %eax
    2acd:	50                   	push   %eax
    2ace:	68 49 4a 00 00       	push   $0x4a49
    2ad3:	6a 01                	push   $0x1
    ...
    2adf:	50                   	push   %eax
    2ae0:	50                   	push   %eax
    2ae1:	68 24 4a 00 00       	push   $0x4a24
    2ae6:	6a 01                	push   $0x1
    ...
    2af2:	52                   	push   %edx
    2af3:	52                   	push   %edx
    2af4:	68 0d 4a 00 00       	push   $0x4a0d
    2af9:	6a 01                	push   $0x1
    ...
    2b05:	51                   	push   %ecx
    2b06:	51                   	push   %ecx
    2b07:	68 c1 4a 00 00       	push   $0x4ac1
    2b0c:	6a 01                	push   $0x1
    ...
    2b18:	53                   	push   %ebx
    2b19:	53                   	push   %ebx
    2b1a:	68 b8 52 00 00       	push   $0x52b8
    2b1f:	6a 01                	push   $0x1
    ...
    2b2b:	50                   	push   %eax
    2b2c:	50                   	push   %eax
    2b2d:	68 a9 4a 00 00       	push   $0x4aa9
    2b32:	6a 01                	push   $0x1
    ...
    2b3e:	50                   	push   %eax
    2b3f:	50                   	push   %eax
    2b40:	68 98 52 00 00       	push   $0x5298
    2b45:	6a 01                	push   $0x1
    ...
    2b51:	50                   	push   %eax
    2b52:	50                   	push   %eax
    2b53:	68 84 4a 00 00       	push   $0x4a84
    2b58:	6a 01                	push   $0x1
    ...
    2b64:	50                   	push   %eax
    2b65:	50                   	push   %eax
    2b66:	68 67 4a 00 00       	push   $0x4a67
    2b6b:	6a 01                	push   $0x1
    ...
    2b84:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    2b8c:	68 e5 4a 00 00       	push   $0x4ae5
    2b91:	6a 01                	push   $0x1
    ...
    2ba3:	68 f6 4a 00 00       	push   $0x4af6
    ...
    2bbb:	68 f6 4a 00 00       	push   $0x4af6
    ...
    2be4:	68 a2 4a 00 00       	push   $0x4aa2
    ...
    2c3a:	68 e0 46 00 00       	push   $0x46e0
  ...
  printf(1, "empty file name OK\n");
    2c5d:	58                   	pop    %eax
    2c5e:	5a                   	pop    %edx
    2c5f:	68 24 4b 00 00       	push   $0x4b24
    2c64:	6a 01                	push   $0x1
    ...
    2c76:	68 fc 4a 00 00       	push   $0x4afc
    2c7b:	6a 01                	push   $0x1
    ...
    2c8a:	68 10 4b 00 00       	push   $0x4b10
    2c8f:	6a 01                	push   $0x1
    ...
    2ca4:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fork test\n");
    2ca9:	68 38 4b 00 00       	push   $0x4b38
    2cae:	6a 01                	push   $0x1
  ...
  printf(1, "fork test OK\n");
    ...
    2cfb:	68 6a 4b 00 00       	push   $0x4b6a
    2d00:	6a 01                	push   $0x1
    ...
    2d13:	68 d8 52 00 00       	push   $0x52d8
    2d18:	6a 01                	push   $0x1
    ...
    2d2c:	68 43 4b 00 00       	push   $0x4b43
    2d31:	6a 01                	push   $0x1
    ...
    2d3d:	50                   	push   %eax
    2d3e:	50                   	push   %eax
    2d3f:	68 57 4b 00 00       	push   $0x4b57
    2d44:	6a 01                	push   $0x1
    ...
    2d56:	31 ff                	xor    %edi,%edi
{
  ...
  printf(stdout, "sbrk test\n");
    2d5b:	68 78 4b 00 00       	push   $0x4b78
    2d60:	ff 35 38 5e 00 00    	pushl  0x5e38
  ...
  *lastaddr = 99;
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2f7a:	6a 01                	push   $0x1
    2f7c:	68 e1 46 00 00       	push   $0x46e1
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2fee:	68 20 4c 00 00       	push   $0x4c20
    2ff3:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    300d:	56                   	push   %esi
    300e:	57                   	push   %edi
    300f:	68 83 4b 00 00       	push   $0x4b83
    3014:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    3040:	50                   	push   %eax
    3041:	50                   	push   %eax
    3042:	68 05 4c 00 00       	push   $0x4c05
    3047:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    306d:	50                   	push   %eax
    306e:	56                   	push   %esi
    306f:	68 ec 4b 00 00       	push   $0x4bec
    3074:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    308c:	51                   	push   %ecx
    308d:	51                   	push   %ecx
    308e:	68 c9 4c 00 00       	push   $0x4cc9
    3093:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    30a3:	50                   	push   %eax
    30a4:	56                   	push   %esi
    30a5:	68 cc 53 00 00       	push   $0x53cc
    30aa:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    30ba:	53                   	push   %ebx
    30bb:	53                   	push   %ebx
    30bc:	68 9c 53 00 00       	push   $0x539c
    30c1:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    30d1:	57                   	push   %edi
    30d2:	56                   	push   %esi
    30d3:	68 74 53 00 00       	push   $0x5374
    30d8:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    30e8:	50                   	push   %eax
    30e9:	56                   	push   %esi
    30ea:	68 3c 53 00 00       	push   $0x533c
    30ef:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    30ff:	56                   	push   %esi
    3100:	56                   	push   %esi
    3101:	68 d1 4b 00 00       	push   $0x4bd1
    3106:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    3116:	57                   	push   %edi
    3117:	57                   	push   %edi
    3118:	68 fc 52 00 00       	push   $0x52fc
    311d:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    3132:	50                   	push   %eax
    3133:	50                   	push   %eax
    3134:	68 b5 4b 00 00       	push   $0x4bb5
    3139:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    3149:	50                   	push   %eax
    314a:	50                   	push   %eax
    314b:	68 9e 4b 00 00       	push   $0x4b9e
    3150:	ff 35 38 5e 00 00    	pushl  0x5e38
...
00003170 <validatetest>:
{
  ...
  printf(stdout, "validate test\n");
    ...
    317a:	68 2e 4c 00 00       	push   $0x4c2e
    317f:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    31bf:	5a                   	pop    %edx
    31c0:	53                   	push   %ebx
    31c1:	68 3d 4c 00 00       	push   $0x4c3d
  ...
  printf(stdout, "validate ok\n");
    ...
    31e4:	68 61 4c 00 00       	push   $0x4c61
    31e9:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    3206:	68 48 4c 00 00       	push   $0x4c48
...
00003220 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    3226:	68 6e 4c 00 00       	push   $0x4c6e
    322b:	ff 35 38 5e 00 00    	pushl  0x5e38
  ...
  printf(stdout, "bss test ok\n");
    ...
    3266:	68 89 4c 00 00       	push   $0x4c89
    ...
    327e:	68 78 4c 00 00       	push   $0x4c78
...
000032a0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    32a6:	68 96 4c 00 00       	push   $0x4c96
  ...
  fd = open("bigarg-ok", 0);
    ...
    32ca:	6a 00                	push   $0x0
    32cc:	68 96 4c 00 00       	push   $0x4c96
  ...
  unlink("bigarg-ok");
    32ea:	c7 04 24 96 4c 00 00 	movl   $0x4c96,(%esp)
    32f1:	e8 1c 06 00 00       	call   3912 <unlink>
}
    32f6:	83 c4 10             	add    $0x10,%esp
    32f9:	c9                   	leave  
    32fa:	c3                   	ret    
    32fb:	b8 60 5e 00 00       	mov    $0x5e60,%eax
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    3300:	c7 00 f0 53 00 00    	movl   $0x53f0,(%eax)
    3306:	83 c0 04             	add    $0x4,%eax
    for(i = 0; i < MAXARG-1; i++)
    3309:	3d dc 5e 00 00       	cmp    $0x5edc,%eax
    330e:	75 f0                	jne    3300 <bigargtest+0x60>
    printf(stdout, "bigarg test\n");
    3310:	51                   	push   %ecx
    3311:	51                   	push   %ecx
    3312:	68 a0 4c 00 00       	push   $0x4ca0
    3317:	ff 35 38 5e 00 00    	pushl  0x5e38
    args[MAXARG-1] = 0;
    331d:	c7 05 dc 5e 00 00 00 	movl   $0x0,0x5edc
    3324:	00 00 00 
    printf(stdout, "bigarg test\n");
    ...
    336d:	50                   	push   %eax
    336e:	50                   	push   %eax
    336f:	68 d6 4c 00 00       	push   $0x4cd6
    3374:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    3384:	52                   	push   %edx
    3385:	52                   	push   %edx
    3386:	68 bd 4c 00 00       	push   $0x4cbd
    ...
    33a6:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fsfull test\n");
    33ab:	68 eb 4c 00 00       	push   $0x4ceb
    33b0:	6a 01                	push   $0x1
    ...
    3433:	50                   	push   %eax
    3434:	68 f8 4c 00 00       	push   $0x4cf8
    3439:	6a 01                	push   $0x1
    ...
    3482:	56                   	push   %esi
    3483:	68 14 4d 00 00       	push   $0x4d14
    3488:	6a 01                	push   $0x1
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    34b6:	50                   	push   %eax
    34b7:	68 04 4d 00 00       	push   $0x4d04
    34bc:	6a 01                	push   $0x1
  ...
  printf(1, "fsfull test finished\n");
    ...
    354a:	68 24 4d 00 00       	push   $0x4d24
    354f:	6a 01                	push   $0x1
...
00003570 <uio>:
{
  ...
  printf(1, "uio test\n");
    3576:	68 3a 4d 00 00       	push   $0x4d3a
    357b:	6a 01                	push   $0x1
  ...
  printf(1, "uio test done\n");
    ...
    3598:	68 44 4d 00 00       	push   $0x4d44
    359d:	6a 01                	push   $0x1
    ...
    35ba:	52                   	push   %edx
    35bb:	52                   	push   %edx
    35bc:	68 d0 54 00 00       	push   $0x54d0
    35c1:	6a 01                	push   $0x1
    ...
    35cd:	50                   	push   %eax
    35ce:	50                   	push   %eax
    35cf:	68 c9 4c 00 00       	push   $0x4cc9
    35d4:	6a 01                	push   $0x1
...
000035e0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    35e7:	6a 00                	push   $0x0
    35e9:	68 53 4d 00 00       	push   $0x4d53
  ...
  printf(1, "arg test passed\n");
    361d:	58                   	pop    %eax
    361e:	5a                   	pop    %edx
    361f:	68 65 4d 00 00       	push   $0x4d65
    3624:	6a 01                	push   $0x1
    ...
    3633:	51                   	push   %ecx
    3634:	51                   	push   %ecx
    3635:	68 58 4d 00 00       	push   $0x4d58
    363a:	6a 02                	push   $0x2
    ...
    3657:	66 19 00 
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    ...
    3663:	a3 34 5e 00 00       	mov    %eax,0x5e34
}
    3668:	c3                   	ret    
    ...
    3989:	85 d2                	test   %edx,%edx
{
  ...
  do{
    ...
    39b7:	f7 f1                	div    %ecx
    39b9:	0f b6 92 28 55 00 00 	movzbl 0x5528(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    3bd4:	e9 8f fe ff ff       	jmp    3a68 <printf+0x48>
          s = "(null)";
    3bd9:	bb 20 55 00 00       	mov    $0x5520,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3bf1:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
{
  ...
  freep = p;
    3c2f:	a3 e0 5e 00 00       	mov    %eax,0x5ee0
}
    3c34:	5b                   	pop    %ebx
    3c35:	5e                   	pop    %esi
    3c36:	5f                   	pop    %edi
    ...
    3c46:	72 ce                	jb     3c16 <free+0x26>
{
  ...
  freep = p;
    3c6a:	a3 e0 5e 00 00       	mov    %eax,0x5ee0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3c8c:	8b 15 e0 5e 00 00    	mov    0x5ee0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    3cd1:	39 05 e0 5e 00 00    	cmp    %eax,0x5ee0
  ...
  return freep;
    3cfb:	8b 15 e0 5e 00 00    	mov    0x5ee0,%edx
    ...
    3d24:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    3d27:	89 15 e0 5e 00 00    	mov    %edx,0x5ee0
}
    ...
    base.s.ptr = freep = prevp = &base;
    3d40:	c7 05 e0 5e 00 00 e4 	movl   $0x5ee4,0x5ee0
    3d47:	5e 00 00 
    3d4a:	c7 05 e4 5e 00 00 e4 	movl   $0x5ee4,0x5ee4
    3d51:	5e 00 00 
    base.s.size = 0;
    3d54:	b8 e4 5e 00 00       	mov    $0x5ee4,%eax
    3d59:	c7 05 e8 5e 00 00 00 	movl   $0x0,0x5ee8
    3d60:	00 00 00 
