...
main(int argc, char *argv[])
{
  ...
  bigwrite();
      7c:	e8 7f 23 00 00       	call   2400 <bigwrite>
  bigargtest();
  ...
  // sbrktest();
  validatetest();
      8b:	e8 d0 30 00 00       	call   3160 <validatetest>

  opentest();
      90:	e8 4b 03 00 00       	call   3e0 <opentest>
  writetest();
      95:	e8 d6 03 00 00       	call   470 <writetest>
  writetest1();
      9a:	e8 b1 05 00 00       	call   650 <writetest1>
  createtest();
      9f:	e8 7c 07 00 00       	call   820 <createtest>

  openiputtest();
      a4:	e8 37 02 00 00       	call   2e0 <openiputtest>
  exitiputtest();
      a9:	e8 42 01 00 00       	call   1f0 <exitiputtest>
  iputtest();
      ae:	e8 5d 00 00 00       	call   110 <iputtest>

  // mem();
  pipe1();
      b3:	e8 48 09 00 00       	call   a00 <pipe1>
  preempt();
      b8:	e8 e3 0a 00 00       	call   ba0 <preempt>
  exitwait();
