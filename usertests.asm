...
main(int argc, char *argv[])
{
  ...
  rmdot();
      c7:	e8 24 27 00 00       	call   27f0 <rmdot>
  fourteen();
      cc:	e8 df 25 00 00       	call   26b0 <fourteen>
  bigfile();
      d1:	e8 0a 24 00 00       	call   24e0 <bigfile>
  subdir();
      d6:	e8 45 1c 00 00       	call   1d20 <subdir>
  linktest();
      db:	e8 f0 14 00 00       	call   15d0 <linktest>
  unlinkread();
      e0:	e8 5b 13 00 00       	call   1440 <unlinkread>
  dirfile();
      e5:	e8 86 28 00 00       	call   2970 <dirfile>
  iref();
      ea:	e8 81 2a 00 00       	call   2b70 <iref>
  forktest();  
      ef:	e8 9c 2b 00 00       	call   2c90 <forktest>
  bigdir();
      f4:	e8 f7 1a 00 00       	call   1bf0 <bigdir>

  uio();
      f9:	e8 62 34 00 00       	call   3560 <uio>

  exectest();
      fe:	e8 ad 08 00 00       	call   9b0 <exectest>

  exit();
     103:	e8 aa 37 00 00       	call   38b2 <exit>
