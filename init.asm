...
main(void)
{
  ...
  1b:	6a 01                	push   $0x1
  1d:	e8 ae 04 00 00       	call   4d0 <printf>
  int pid, wpid;
  ...
  2b:	e8 73 03 00 00       	call   3a3 <open>
  30:	83 c4 10             	add    $0x10,%esp
  33:	85 c0                	test   %eax,%eax
  35:	0f 88 9d 00 00 00    	js     d8 <main+0xd8>
    mknod("console", 1, 1);
    open("console", O_RDWR);
  }
  dup(0);  // stdout
  ...
  4c:	e8 8a 03 00 00       	call   3db <dup>
  ...
  b4:	50                   	push   %eax
  b5:	50                   	push   %eax
  b6:	68 44 0b 00 00       	push   $0xb44
  bb:	68 6e 08 00 00       	push   $0x86e
  c0:	e8 d6 02 00 00       	call   39b <exec>
      printf(1, "init: exec sh failed\n");
  c5:	5a                   	pop    %edx
  c6:	59                   	pop    %ecx
  c7:	68 71 08 00 00       	push   $0x871
  cc:	6a 01                	push   $0x1
  ...
  d9:	6a 01                	push   $0x1
  db:	6a 01                	push   $0x1
  dd:	68 40 08 00 00       	push   $0x840
  e2:	e8 c4 02 00 00       	call   3ab <mknod>
    open("console", O_RDWR);
  e7:	58                   	pop    %eax
  e8:	5a                   	pop    %edx
  e9:	6a 02                	push   $0x2
  eb:	68 40 08 00 00       	push   $0x840
  f0:	e8 ae 02 00 00       	call   3a3 <open>
  f5:	83 c4 10             	add    $0x10,%esp
  f8:	e9 3e ff ff ff       	jmp    3b <main+0x3b>
  fd:	66 90                	xchg   %ax,%ax
  ff:	90                   	nop
 ...
 42c:	89 d1                	mov    %edx,%ecx
{
 ...
 459:	0f b6 92 98 08 00 00 	movzbl 0x898(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 654:	eb 1a                	jmp    670 <printf+0x1a0>
          s = "(null)";
 656:	bb 90 08 00 00       	mov    $0x890,%ebx
        while(*s != 0){
 ...
 6c6:	73 10                	jae    6d8 <free+0x38>
{
 ...
 6f1:	5b                   	pop    %ebx
  freep = p;
 6f2:	a3 4c 0b 00 00       	mov    %eax,0xb4c
}
 6f7:	5e                   	pop    %esi
 6f8:	5f                   	pop    %edi
 6f9:	5d                   	pop    %ebp
 ...
 717:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 71a:	a3 4c 0b 00 00       	mov    %eax,0xb4c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 73d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 740:	8b 3d 4c 0b 00 00    	mov    0xb4c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 789:	8b 3d 4c 0b 00 00    	mov    0xb4c,%edi
 ...
 7b2:	e8 e9 fe ff ff       	call   6a0 <free>
  return freep;
 7b7:	a1 4c 0b 00 00       	mov    0xb4c,%eax
 ...
 7fe:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 800:	c7 05 4c 0b 00 00 50 	movl   $0xb50,0xb4c
 807:	0b 00 00 
    base.s.size = 0;
 80a:	bf 50 0b 00 00       	mov    $0xb50,%edi
    base.s.ptr = freep = prevp = &base;
 80f:	c7 05 50 0b 00 00 50 	movl   $0xb50,0xb50
 816:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
